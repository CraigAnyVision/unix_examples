...
int main(int argc, char *argv[])
{
	...
	print_sysconf("sysconf says _POSIX_ADVISORY_INFO =", _SC_ADVISORY_INFO);
#else
	...
	print_sysconf("sysconf says _POSIX_ASYNCHRONOUS_IO =", _SC_ASYNCHRONOUS_IO);
#else
...
#endif
#ifdef _SC_BARRIERS
	print_sysconf("sysconf says _POSIX_BARRIERS =", _SC_BARRIERS);
#else
	...
	print_sysconf("sysconf says _POSIX_CLOCK_SELECTION =", _SC_CLOCK_SELECTION);
#else
...
#endif
#ifdef _SC_CPUTIME
	print_sysconf("sysconf says _POSIX_CPUTIME =", _SC_CPUTIME);
#else
...
#endif
#ifdef _SC_FSYNC
	print_sysconf("sysconf says _POSIX_FSYNC =", _SC_FSYNC);
#else
...
#endif
#ifdef _SC_IPV6
	print_sysconf("sysconf says _POSIX_IPV6 =", _SC_IPV6);
#else
	...
	print_sysconf("sysconf says _POSIX_JOB_CONTROL =", _SC_JOB_CONTROL);
#else
	...
	print_sysconf("sysconf says _POSIX_MAPPED_FILES =", _SC_MAPPED_FILES);
#else
...
#endif
#ifdef _SC_MEMLOCK
	print_sysconf("sysconf says _POSIX_MEMLOCK =", _SC_MEMLOCK);
#else
	...
	print_sysconf("sysconf says _POSIX_MEMLOCK_RANGE =", _SC_MEMLOCK_RANGE);
#else
	...
	print_sysconf("sysconf says _POSIX_MEMORY_PROTECTION =", _SC_MEMORY_PROTECTION);
#else
	...
	print_sysconf("sysconf says _POSIX_MESSAGE_PASSING =", _SC_MESSAGE_PASSING);
#else
	...
	print_sysconf("sysconf says _POSIX_MONOTONIC_CLOCK =", _SC_MONOTONIC_CLOCK);
#else
	...
	print_sysconf("sysconf says _POSIX_PRIORITIZED_IO =", _SC_PRIORITIZED_IO);
#else
	...
	print_sysconf("sysconf says _POSIX_PRIORITY_SCHEDULING =", _SC_PRIORITY_SCHEDULING);
#else
	...
	print_sysconf("sysconf says _POSIX_RAW_SOCKETS =", _SC_RAW_SOCKETS);
#else
	...
	print_sysconf("sysconf says _POSIX_READER_WRITER_LOCKS =", _SC_READER_WRITER_LOCKS);
#else
	...
	print_sysconf("sysconf says _POSIX_REALTIME_SIGNALS =", _SC_REALTIME_SIGNALS);
#else
...
#endif
#ifdef _SC_REGEXP
	print_sysconf("sysconf says _POSIX_REGEXP =", _SC_REGEXP);
#else
...
#endif
#ifdef _SC_SAVED_IDS
	print_sysconf("sysconf says _POSIX_SAVED_IDS =", _SC_SAVED_IDS);
#else
	...
	print_sysconf("sysconf says _POSIX_SEMAPHORES =", _SC_SEMAPHORES);
#else
	...
	print_sysconf("sysconf says _POSIX_SHARED_MEMORY_OBJECTS =", _SC_SHARED_MEMORY_OBJECTS);
#else
...
#endif
#ifdef _SC_SHELL
	print_sysconf("sysconf says _POSIX_SHELL =", _SC_SHELL);
#else
...
#endif
#ifdef _SC_SPAWN
	print_sysconf("sysconf says _POSIX_SPAWN =", _SC_SPAWN);
#else
	...
	print_sysconf("sysconf says _POSIX_SPIN_LOCKS =", _SC_SPIN_LOCKS);
#else
	...
	print_sysconf("sysconf says _POSIX_SPORADIC_SERVER =", _SC_SPORADIC_SERVER);
#else
	...
	print_sysconf("sysconf says _POSIX_SYNCHRONIZED_IO =", _SC_SYNCHRONIZED_IO);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_ATTR_STACKADDR =", _SC_THREAD_ATTR_STACKADDR);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_ATTR_STACKSIZE =", _SC_THREAD_ATTR_STACKSIZE);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_ATTR_CPUTIME =", _SC_THREAD_CPUTIME);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_PRIO_INHERIT =", _SC_THREAD_PRIO_INHERIT);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_PRIORITY_SCHEDULING =", _SC_THREAD_PRIORITY_SCHEDULING);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_PROCESS_SHARED =", _SC_THREAD_PROCESS_SHARED);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_ROBUST_PRIO_INHERIT =", _SC_THREAD_ROBUST_PRIO_INHERIT);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_ROBUST_PRIO_PROTECT =", _SC_THREAD_ROBUST_PRIO_PROTECT);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_SAFE_FUNCTIONS =", _SC_THREAD_SAFE_FUNCTIONS);
#else
	...
	print_sysconf("sysconf says _POSIX_THREAD_SPORADIC_SERVER =", _SC_THREAD_SPORADIC_SERVER);
#else
...
#endif
#ifdef _SC_THREADS
	print_sysconf("sysconf says _POSIX_THREADS =", _SC_THREADS);
#else
...
#endif
#ifdef _SC_TIMEOUTS
	print_sysconf("sysconf says _POSIX_TIMEOUTS =", _SC_TIMEOUTS);
#else
...
#endif
#ifdef _SC_TIMERS
	print_sysconf("sysconf says _POSIX_TIMERS =", _SC_TIMERS);
#else
	...
	print_sysconf("sysconf says _POSIX_TYPED_MEMORY_OBJECTS =", _SC_TYPED_MEMORY_OBJECTS);
#else
...
#endif
#ifdef _SC_VERSION
	print_sysconf("sysconf says _POSIX_VERSION =", _SC_VERSION);
#else
	...
	print_sysconf("sysconf says _XOPEN_CRYPT =", _SC_XOPEN_CRYPT);
#else
	...
	print_sysconf("sysconf says _XOPEN_ENH_I18N =", _SC_XOPEN_ENH_I18N);
#else
	...
	print_sysconf("sysconf says _XOPEN_REALTIME =", _SC_XOPEN_REALTIME);
#else
	...
	print_sysconf("sysconf says _XOPEN_REALTIME_THREADS =", _SC_XOPEN_REALTIME_THREADS);
#else
...
#endif
#ifdef _SC_XOPEN_SHM
	print_sysconf("sysconf says _XOPEN_SHM =", _SC_XOPEN_SHM);
#else
	...
	print_sysconf("sysconf says _XOPEN_UNIX =", _SC_XOPEN_UNIX);
#else
	...
	print_sysconf("sysconf says _XOPEN_UUCP =", _SC_XOPEN_UUCP);
#else
	...
	print_sysconf("sysconf says _XOPEN_VERSION =", _SC_XOPEN_VERSION);
#else
	...
	print_pathconf("pathconf says _POSIX_CHOWN_RESTRICTED =", argv[1], _PC_CHOWN_RESTRICTED);
#else
...
#endif
#ifdef _PC_NO_TRUNC
	print_pathconf("pathconf says _POSIX_NO_TRUNC =", argv[1], _PC_NO_TRUNC);
#else
...
#endif
#ifdef _PC_VDISABLE
	print_pathconf("pathconf says _POSIX_VDISABLE =", argv[1], _PC_VDISABLE);
#else
...
#endif
#ifdef _PC_ASYNC_IO
	print_pathconf("pathconf says _POSIX_ASYNC_IO =", argv[1], _PC_ASYNC_IO);
#else
...
#endif
#ifdef _PC_PRIO_IO
	print_pathconf("pathconf says _POSIX_PRIO_IO =", argv[1], _PC_PRIO_IO);
#else
...
#endif
#ifdef _PC_SYNC_IO
	print_pathconf("pathconf says _POSIX_SYNC_IO =", argv[1], _PC_SYNC_IO);
#else
	...
	print_pathconf("pathconf says _POSIX2_SYMLINKS =", argv[1], _PC_2_SYMLINKS);
#else
